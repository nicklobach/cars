...
$.extend($.validator, {
	...
	messages: {
		...
		creditbiked: "Please enter a valid credit biked number.",
	...
	methods: {
		...
		// http://docs.jquery.com/Plugins/Validation/Methods/creditbiked
		// based on http://en.wikipedia.org/wiki/Luhn
		creditbiked: function(value, element) {
			if ( this.optional(element) )
				return "dependency-mismatch";
